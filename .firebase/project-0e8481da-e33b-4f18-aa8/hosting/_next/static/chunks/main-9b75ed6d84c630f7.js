          ...
          i
            ...
            .then((n) => {
              ...
              return (null == l ? void 0 : l.Component) === a
                ? r
                    .e(646)
                    .then(r.t.bind(r, 31646, 23))
                    .then((n) =>
                      r
                        .e(139)
                        .then(r.t.bind(r, 45139, 23))
      ...
      class Y {
            ...
            for (let { as: r, allowMatchCurrent: u } of [{ as: e }, { as: t }])
              if (r) {
                ...
                if (
                  u ||
                  t !==
                    (0, i.removeTrailingSlash)(new URL(this.asPath, "http://n").pathname)
                ) {
                  var o, s, l;
                  for (let e of ((c =
                    c ||
        ...
        async change(e, t, r, a, o) {
          ...
          let eu = !!(
            ...
            es = !a.shallow && (await U({ asPath: r, locale: q.locale, router: this }));
            ...
            if (((a._shouldResolveHref = !0), r.startsWith("/"))) {
              ...
              (es || (ea = e.asPath),
                e.matchedPage &&
                  ...
                  es || (t = (0, E.formatWithValidation)(et))));
            } else
              ((et.pathname = B(er, L)),
                et.pathname !== er &&
                  ((er = et.pathname),
          ...
          try {
            ...
            if (
              (H ||
                a.shallow ||
                (await this._bfl(r, "resolvedAs" in n ? n.resolvedAs : void 0, q.locale)),
              "route" in n && es)
            ) {
              ((eo = er = n.route || eo),
            ...
            if ("type" in n)
              if ("redirect-internal" === n.type)
                ...
                return (z({ url: n.destination, router: this }), new Promise(() => {}));
            let i = n.Component;
            if (
              (i &&
              ...
              if (((q.isPreview = !!n.props.__N_PREVIEW), n.props.notFound === X)) {
                let e;
                try {
            ...
            let u = a.shallow && q.route === (null != (T = n.route) ? T : eo),
              c = null != (A = a.scroll) ? A : !H && !u,
              p = null != o ? o : c ? { x: 0, y: 0 } : null,
              E = { ...q, route: eo, pathname: er, query: en, asPath: Z, isFallback: !1 };
            if (H && ec) {
              if (
                ((n = await this.getRouteInfo({
                  route: this.pathname,
              ...
              "/_error" === this.pathname &&
                (null == (x = self.__NEXT_DATA__.props) || null == (j = x.pageProps)
                  ? void 0
                  : j.statusCode) === 500 &&
                (null == (M = n.props) ? void 0 : M.pageProps) &&
                (n.props.pageProps.statusCode = 500);
              try {
                await this.set(E, n, p);
              } catch (e) {
                throw (
                  (0, l.default)(e) &&
                    e.cancelled &&
            ...
            if (
              ...
              !(H && !p && !G && !ee && (0, C.compareRouterStates)(E, this.state)))
            ) {
              try {
                await this.set(E, n, p);
              } catch (e) {
              ...
              if (n.error)
                throw (H || Y.events.emit("routeChangeError", n.error, Z, J), n.error);
            ...
            if (
              ...
              h &&
                (S
                  ...
                  : (S = { json: self.__NEXT_DATA__.props })),
              t(),
              (null == S || null == (y = S.effect) ? void 0 : y.type) ===
                "redirect-internal" ||
            ...
            if ((null == S || null == (P = S.effect) ? void 0 : P.type) === "rewrite") {
              ...
              if (
                ...
                (o = (0, v.removeBasePath)(
                  (0, f.normalizeLocalePath)(S.effect.parsedAs.pathname, this.locales)
                    .pathname,
                )),
                (e = this.components[g]),
        ...
        async prefetch(e, t, r) {
          ...
          if (t.startsWith("/")) {
            ...
            (O || (d = (0, P.removeLocale)((0, v.removeBasePath)(o.asPath), this.locale)),
              o.matchedPage &&
                ...
                O || (e = (0, E.formatWithValidation)(a))));
          }
          ...
          let S = await H({
            fetchData: () =>
              q({
                dataHref: this.pageLoader.getDataHref({
                  href: (0, E.formatWithValidation)({ pathname: c, query: l }),
                  skipInterpolation: !0,
                  asPath: d,
                  locale: p,
                }),
      ...
      function g(e) {
        ...
        if (
          ...
          ("beforeInteractive" === l || "worker" === l) &&
            (g
              ? ((E[l] = (E[l] || []).concat([
                  { id: t, src: r, onLoad: n, onReady: a, onError: d, ...m, nonce: P },
                ])),
                g(E))
              : y && y()
                ? p.add(t || r)
