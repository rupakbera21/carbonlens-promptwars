  ...
  [489],
  {
              ...
              if ("undefined" != typeof window)
                try {
                  localStorage.setItem(
                    e,
                    JSON.stringify(i(i({}, t), {}, { timestamp: f() })),
                  );
                } catch (e) {}
            },
          };
    ...
    36489: (e, t, r) => {
      ...
      ((t.SessionContext = void 0),
        (t.SessionProvider = function (e) {
                    ...
                    function (e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          ...
                          case 10:
                            if (
                              !(!t || null === j._session || (0, _.now)() < j._lastSync)
                            ) {
                              e.next = 12;
                              break;
                            }
          ...
          return (0, g.jsx)(M.Provider, { value: L, children: s });
        }),
        (t.getCsrfToken = T),
        (t.getProviders = L),
        (t.getSession = R),
      ...
      var j = {
          baseUrl: (0, b.default)(null != (n = i.env.NEXTAUTH_URL) ? n : i.env.VERCEL_URL)
            .origin,
          basePath: (0, b.default)(i.env.NEXTAUTH_URL).path,
          baseUrlServer: (0, b.default)(
            null !=
              (o = null != (a = i.env.NEXTAUTH_URL_INTERNAL) ? a : i.env.NEXTAUTH_URL)
              ? o
              : i.env.VERCEL_URL,
          ).origin,
        ...
        M = (t.SessionContext =
          null == (s = x.createContext) ? void 0 : s.call(x, void 0));
      function R(e) {
        ...
        if (null != r) {
          ...
          try {
            if (((a = (r = r.call(e)).next), 0 === t)) {
              ...
              for (
                ;
                !(i = (n = a.call(r)).done) && (s.push(n.value), s.length !== t);
                i = !0
              );
          } catch (e) {
            ((c = !0), (o = e));
    ...
    56445: (e, t, r) => {
      ...
      function c(e) {
        ...
        if (null != (t = e) && t.error) {
          ((e.error = c(e.error)),
            (e.message = null != (r = e.message) ? r : e.error.message));
        }
        return e;
      }
      var l = {
                      ...
                      function (r) {
                        for (;;)
                          switch ((r.prev = r.next)) {
                            case 0:
                              for (
                                r.prev = 0, u = Array((a = l.length)), s = 0;
                                s < a;
                                s++
                              )
                                u[s] = l[s];
      ...
      var v = (t.UnknownError = (function (e) {
        function t(e) {
          ...
          return (
            (0, s.default)(this, t),
            ((n = p(this, t, [
              null != (r = null == e ? void 0 : e.message) ? r : e,
            ])).name = "UnknownError"),
            (n.code = e.code),
